...
<html lang="ko" dir="ltr">
  ...
  <body>
    ...
    <div class="des">
      <span class="naver">키워드 연령별 </span><span>트렌드 조회 📈</span>
      ...
      <form method="post">
        <div class="end-menu">
          <button type="button" class="btn btn-outline-dark" id="searchAges">연령별 인기 키워드 조회</button>
          <div class="last-menu">
            <div class="ages-group">
              ...
              <div class="form-check form-check-inline">
                ...
                <label class="form-check-label" for="inlineCheckbox3">30대</label>
              </div>
            </div>
            <div class="search">
                <input type="submit" class="btn btn-light" id="finish3" name="finish" value="조회">
            </div>
          </div>
          <div class="search2">
            <span>검색 조건</span>

...
$result = mysqli_query($conn, "SELECT * from shop ORDER BY ratio DESC");
$result2 = mysqli_query($conn, "SELECT * FROM shop2 ORDER BY ratio DESC");
$result3 = mysqli_query($conn, "SELECT * FROM shop3 ORDER BY ratio DESC");
$number = 1;
?>
...
<html lang="ko" dir="ltr">
  ...
  <body>
    ...
    <div class="des">
      <span class="naver">키워드별 </span><span>트렌드 조회 📈</span>
      ...
      <form method="post">
        <div class="top-menu">
          <div class="btn-group">
            <select class="form-select dropdown" aria-label="Default select example" name='list1[]'>
